...
import "./switch.css"
const SwitchPopular = ({items, onToggle, isToggled}) => {
...
// setItem3Width(item3ref.current.offsetWidth);
},[])
...
return <div className="switch">
 ...
 {/* <div ref={item3ref} onClick={onClickHeader.bind(null,items[2])} className={`switch_items ${ isToggled ? 'activecolor': ''}`}>{items[2]}</div> */}
 <div className="bkg_item" style={
    isToggled?{
        left:`${item1Width}px`,
    width:`${item2Width+3}px`
        }:{
left:'0',
width:`${item1Width}px`
        }
